...
ECO_BIKES_PARAMS_API = {"client_id": API_CLIENT_ID, "client_secret": API_CLIENT_SECRET}
...
GCP_BQ_JSON_CREDENTIALS = os.getenv("GCP_BQ_JSON_CREDENTIALS")
GCP_PROJECT_ID = os.getenv("GCP_PROJECT_ID")
GCP_DATASET_ID = os.getenv("GCP_DATASET_ID")
GCP_STORAGE_JSON_CREDENTIALS = os.getenv("GCP_STORAGE_JSON_CREDENTIALS")
