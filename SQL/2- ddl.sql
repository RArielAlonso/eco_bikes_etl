...
CREATE TABLE IF NOT EXISTS eco_bikes.system_info_eco_bikes (
	...
	mobile_head_version text NULL,
	mobile_minimum_supported_version text NULL,
	vehicle_count_mechanical_count int8 NULL,
	vehicle_count_ebike_count int8 NULL,
	station_count int8 NULL,
	reload_id int4 NOT NULL,
	PRIMARY KEY (reload_id),
	FOREIGN KEY (reload_id)	REFERENCES eco_bikes.metadata_load(reload_id)
);
